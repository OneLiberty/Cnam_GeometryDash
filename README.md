...
![Usecase](./Diagrams/Usecase.svg)

### Activity diagram

![Activity](./Diagrams/Activity.svg)
...
- **Espace, Clic gauche** : Saut - _**Modifiable**_
- **Echap** : Menu pause - _**Modifiable**_
- **R** : Recommencer le niveau - _**Modifiable**_
...
- **Z, Q, S, D** : Déplacement de la caméra - _**Modifiable**_
